...
namespace DersDemo_ASP_AjaxWebService.DataLayer
{
    ...
    partial void OnOldUnitPriceChanging(decimal value);
    partial void OnOldUnitPriceChanged();
    #endregion
		...
		[Column(Storage="_OldUnitPrice", DbType="Money NOT NULL")]
		public decimal OldUnitPrice
		{
			get
			{
				return this._OldUnitPrice;
			}
			set
			{
				if ((this._OldUnitPrice != value))
				{
					this.OnOldUnitPriceChanging(value);
					this.SendPropertyChanging();
					this._OldUnitPrice = value;
					this.SendPropertyChanged("OldUnitPrice");
					this.OnOldUnitPriceChanged();
				}
			}
		}
